// scripts/benchmark.js - 真实 E2E 质量基线 (补 R1: 量化完成率/延迟/Token)
// 用本地/配置模型跑固定任务集, 输出逐项结果 + 汇总。默认 LM Studio 本地 gemma。
// 用法: node scripts/benchmark.js
import fs from "node:fs";
import { LLMClient } from "../src/llm/client.js";

const config = {
  id: "lmstudio", base_url: "http://127.0.0.1:1234/v1", api_key: "lm-studio",
  model: "gemma-4-e2b-uncensored-hauhaucs-aggressive-q8_k_p", vision: true, timeout_ms: 120000,
};

const IMG = "C:\\Users\\chen\\.workbuddy\\clipboard-images\\clipboard-2026-08-16T13-40-17-784Z-5568b0a1.png";
...
const CASES = [
  ...
  { name: "工具-时间", prompt: "现在几点了？用 get_time 工具查。", expect: ["2026", "21:", "22:"], useTools: true },
  { name: "工具-读文件", prompt: "读 README.md 第一行, 告诉我这个项目叫什么。", expect: ["皮皮虾"], useTools: true },
  { name: "多轮工具链", prompt: "先读 README.md 第一行告诉我项目名, 再用 get_time 查一下现在几点。", expect: ["皮皮虾", "2026", "22:"], useTools: true },
...
(async () => {
  ...
  console.log(`→ E2E 质量基线 | 后端: ${config.model}\n`);
  let pass = 0;
  const results = [];
